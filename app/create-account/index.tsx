...
export default function CreateAccountScreen() {
  return (
    <ScrollView>
      <YStack flex={1} alignItems="center" gap="$5" px="$5" py="$10" backgroundColor="white">
        <Image source={logo} width={200} height={50} objectFit="contain" />

        <YStack w="100%">
          <VText type='h2' my={10}>Create An Account</VText>
          <Paragraph fontSize={12} maxWidth={250}>Please complete all input fields to create your account</Paragraph>
        </YStack>
        ...
        <YStack>
          <VText>
            ...
            <VText fontWeight={600} color="$primary">Terms of Service</VText>
          </VText>
          <VText alignSelf='center'>
            <VText fontWeight={600}>and </VText>
            <VText fontWeight={600} color="$primary">Privacy Policy</VText>
          </VText>
        </YStack>
